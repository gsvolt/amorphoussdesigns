	...
	// jQuery
		jQuery(function() {
			...
			// Gallery
				...
				$('.gallery2').poptrox(_settings.poptrox);
				$('.gallery3').poptrox(_settings.poptrox);
				$('.gallery4').poptrox(_settings.poptrox);
				$('.gallery5').poptrox(_settings.poptrox);
				$('.gallery6').poptrox(_settings.poptrox);
